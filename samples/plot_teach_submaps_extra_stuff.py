...
if __name__ == '__main__':
    ...
    for submap_pcd in submap_pcds:
        ...
        # # Extend lists with points from each submap point cloud
        # for p, c in zip(combined_points, combined_colors):
...
# Create the combined point cloud from the accumulated lists
...
# # Add the aggregated point cloud to the visualizer
